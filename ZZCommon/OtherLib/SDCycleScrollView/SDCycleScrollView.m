...
- (void)initialization
{
    ...
    _titleLabelTextFont= CodeFontMake(SS(14));
...
- (void)layoutSubviews
{
    ...
    CGSize size = CGSizeMake(2 + 12 * self.imagePathsGroup.count, 6);
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (!self.onlyDisplayText && [imagePath isKindOfClass:[NSString class]]) {
        if ([imagePath hasPrefix:@"http"]) {
            [cell.imageView sd_setImageWithURL:[NSURL URLWithString:imagePath] placeholderImage:[[UIImage qmui_imageWithColor:self.backgroundColor size:self.qmui_size cornerRadius:0] qmui_imageWithImageAbove:self.placeholderImage atPoint:self.center]];
        } else {
