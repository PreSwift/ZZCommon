...
#import "QDPasswordLoginViewController.h"

@interface QDBaseLoginViewController ()

@end

@implementation QDBaseLoginViewController
...
- (void)changeWay {
    ...
    if ([self isKindOfClass:[QDPasswordLoginViewController class]]) {
