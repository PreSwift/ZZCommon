...
- (void)setImageData {
    _items = @[
        [[QDWelcomePageItem alloc] initWithImageName:@"引导页-1" text1:@"产品体验，全面升级" text2:@"焕然一新，全新开始"],
        [[QDWelcomePageItem alloc] initWithImageName:@"引导页-2" text1:@"成绩报告，精准分析" text2:@"成绩追踪，全面分析"],
        [[QDWelcomePageItem alloc] initWithImageName:@"引导页-3" text1:@"掌上阅卷，高效智能" text2:@"随时随地，快速批改"],
    ];
