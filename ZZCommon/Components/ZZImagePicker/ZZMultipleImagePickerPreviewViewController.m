//
//  ZZMultipleImagePickerPreviewViewController.m
//
...
@interface ZZMultipleImagePickerPreviewViewController ()
...
@implementation ZZMultipleImagePickerPreviewViewController
...
- (void)viewDidLayoutSubviews {
    ...
    self.topToolBarView.frame = CGRectMake(0, 0, CGRectGetWidth(self.view.bounds), 64);
    self.backButton.frame = CGRectSetXY(self.backButton.frame, 16 + self.view.safeAreaInsets.left, (64 - self.backButton.qmui_height) / 2);
    if (!self.checkboxButton.hidden) {
        self.checkboxButton.frame = CGRectSetXY(self.checkboxButton.frame, CGRectGetWidth(self.topToolBarView.frame) - 10 - self.view.safeAreaInsets.right - CGRectGetWidth(self.checkboxButton.frame), (64 - self.checkboxButton.qmui_height) / 2);
    }
