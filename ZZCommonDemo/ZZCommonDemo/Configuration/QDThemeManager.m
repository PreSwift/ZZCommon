...
- (instancetype)init {
    if (self = [super init]) {
        ...
        self.qd_imageViewBackgroundColor = [UIColor qmui_colorWithThemeProvider:^UIColor * _Nonnull(__kindof QMUIThemeManager * _Nonnull manager, __kindof NSObject<NSCopying> * _Nullable identifier, NSObject<QDThemeProtocol> *theme) {
        ...
        self.qd_auxiliaryColor1 = [UIColor qmui_colorWithThemeProvider:^UIColor * _Nonnull(__kindof QMUIThemeManager * _Nonnull manager, __kindof NSObject<NSCopying> * _Nullable identifier, NSObject<QDThemeProtocol> *theme) {
            return theme.themeAuxiliaryColor1;
        }];
        self.qd_auxiliaryColor2 = [UIColor qmui_colorWithThemeProvider:^UIColor * _Nonnull(__kindof QMUIThemeManager * _Nonnull manager, __kindof NSObject<NSCopying> * _Nullable identifier, NSObject<QDThemeProtocol> *theme) {
            return theme.themeAuxiliaryColor2;
        }];
        self.qd_auxiliaryColor3 = [UIColor qmui_colorWithThemeProvider:^UIColor * _Nonnull(__kindof QMUIThemeManager * _Nonnull manager, __kindof NSObject<NSCopying> * _Nullable identifier, NSObject<QDThemeProtocol> *theme) {
...
+ (UIColor *)qd_imageViewBackgroundColor {
    return QDThemeManager.sharedInstance.qd_imageViewBackgroundColor;
}
...
+ (UIFont *)qd_navigationBarTitleFont {
    return QDThemeManager.sharedInstance.qd_navigationBarTitleFont;
}

+ (UIFont *)qd_titleFont {
    return QDThemeManager.sharedInstance.qd_titleFont;
}

+ (UIFont *)qd_titleMediumFont {
    return QDThemeManager.sharedInstance.qd_titleMediumFont;
}

+ (UIFont *)qd_titleBoldFont {
    return QDThemeManager.sharedInstance.qd_titleBoldFont;
}
...
+ (UIFont *)qd_mainTextMediumFont {
    return QDThemeManager.sharedInstance.qd_mainTextMediumFont;
}

+ (UIFont *)qd_mainTextBoldFont {
    return QDThemeManager.sharedInstance.qd_mainTextBoldFont;
}
...
+ (UIFont *)qd_descriptionTextMediumFont {
    return QDThemeManager.sharedInstance.qd_descriptionTextMediumFont;
}

+ (UIFont *)qd_descriptionTextBoldFont {
    return QDThemeManager.sharedInstance.qd_descriptionTextBoldFont;
}

+ (UIFont *)qd_otherFont {
    return QDThemeManager.sharedInstance.qd_otherFont;
}

+ (UIFont *)qd_otherMediumFont {
    return QDThemeManager.sharedInstance.qd_otherMediumFont;
}

+ (UIFont *)qd_otherBoldFont {
    return QDThemeManager.sharedInstance.qd_otherBoldFont;
}
