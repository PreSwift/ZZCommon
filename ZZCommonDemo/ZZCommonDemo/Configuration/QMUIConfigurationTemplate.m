...
#pragma mark - Global Color
    ...
    QMUICMI.blueColor = UIColorMake(104, 137, 187);                                    // UIColorBlue : 蓝色
    ...
    QMUICMI.separatorDashedColor = UIColor.qd_separatorColor;                  // UIColorSeparatorDashed : 全局默认的虚线分隔线的颜色，默认 QMUIKit 暂时没用到
...
#pragma mark - NavigationBar
    ...
    QMUICMI.navBarButtonFont = UIFontMake(14);                                  // NavBarButtonFont : UINavigationBar 里 UIBarButtonItem 以及 QMUINavigationButtonTypeNormal 的字体
    QMUICMI.navBarButtonFontBold = UIFontBoldMake(14);                          // NavBarButtonFontBold : iOS 15 及以后用于设置 UINavigationBar 里 Done 类型的 UIBarButtonItem 以及 QMUINavigationButtonTypeBold 的字体，iOS 14 及以前只对后者生效
    QMUICMI.navBarBackgroundImage = [UIImage qmui_imageWithColor:UIColorWhite];    // NavBarBackgroundImage : UINavigationBar 的背景图，注意 navigationBar 的高度会受多个因素（是否全面屏、是否使用了 navigationItem.prompt、是否将 UISearchBar 作为 titleView）的影响，要检查各种情况是否都显示正常。
    if (@available(iOS 15.0, *)) {
    ...
    QMUICMI.navBarTintColor = [UIColor qd_mainTextColor];                                     // NavBarTintColor : NavBarContainerClasses 里的 UINavigationBar 的 tintColor，也即导航栏上面的按钮颜色
    ...
    QMUICMI.navBarTitleFont = UIFont.qd_navigationBarTitleFont;                               // NavBarTitleFont : UINavigationBar 的标题字体，以及 QMUINavigationTitleView 的默认字体
...
#pragma mark - SearchBar
    ...
    QMUICMI.searchBarTextFieldBackgroundImage = [[UIImage qmui_imageWithColor:UIColor.qd_imageViewBackgroundColor size:CGSizeMake(60, 44) cornerRadius:0] resizableImageWithCapInsets:UIEdgeInsetsZero];       // SearchBarTextFieldBackgroundImage : QMUISearchBar 里的文本框的背景图，图片高度会决定输入框的高度
    ...
    QMUICMI.searchBarTextColor = UIColor.qd_mainTextColor;                                  // SearchBarTextColor : QMUISearchBar 里的文本框的文字颜色
    ...
    QMUICMI.searchBarFont = UIFont.qd_mainTextFont;                                                // SearchBarFont : QMUISearchBar 里的文本框的文字字体及 placeholder 的字体
...
#pragma mark - Grouped TableView
    ...
    QMUICMI.tableViewGroupedBackgroundColor = [UIColor qmui_colorWithThemeProvider:^UIColor * _Nonnull(__kindof QMUIThemeManager * _Nonnull manager, NSString * _Nullable identifier, NSObject<QDThemeProtocol> * _Nullable theme) {
        ...
        return UIColor.qd_imageViewBackgroundColor;
    ...
    QMUICMI.tableViewGroupedSectionHeaderFont = UIFont.qd_descriptionTextFont;                                         // TableViewGroupedSectionHeaderFont : Grouped 类型的 QMUITableView sectionHeader 里的文字字体
    QMUICMI.tableViewGroupedSectionFooterFont = UIFont.qd_descriptionTextFont;                                         // TableViewGroupedSectionFooterFont : Grouped 类型的 QMUITableView sectionFooter 里的文字字体
    QMUICMI.tableViewGroupedSectionHeaderTextColor = UIColor.qd_mainTextColor;                                 // TableViewGroupedSectionHeaderTextColor : Grouped 类型的 QMUITableView sectionHeader 里的文字颜色
    QMUICMI.tableViewGroupedSectionFooterTextColor = UIColor.qd_mainTextColor;                                       // TableViewGroupedSectionFooterTextColor : Grouped 类型的 QMUITableView sectionFooter 里的文字颜色
...
#pragma mark - QMUIBadge
    ...
    QMUICMI.badgeFont = UIFontMake(10);                                     // BadgeFont : QMUIBadge 上的未读数的字体
...
- (UIColor *)themeBackgroundColorLighten {
    return UIColorMakeWithHex(@"#F6F7F9");
}

- (UIColor *)themeBackgroundColorHighlighted {
    return UIColorMakeWithHex(@"#ECF2FE");
}

- (UIColor *)themeImageViewBackgroundColor {
    return UIColorMakeWithHex(@"#F7F7F7");
}

- (UIColor *)themeTintColor {
    return UIColorMakeWithHex(@"#C41C12");
}

- (UIColor *)themeAuxiliaryColor1 {
    return UIColorMakeWithHex(@"#35CD9B");
}

- (UIColor *)themeAuxiliaryColor2 {
    return UIColorMakeWithHex(@"#EB263C");
}

- (UIColor *)themeAuxiliaryColor3 {
    return UIColorMakeWithHex(@"#FCAD38");
}

- (UIColor *)themeTitleTextColor {
    return UIColorMakeWithHex(@"#131212");
}

- (UIColor *)themeMainTextColor {
    return UIColorMakeWithHex(@"#555252");
}

- (UIColor *)themeDescriptionTextColor {
    return UIColorMakeWithHex(@"#949494");
}

- (UIColor *)themePlaceholderColor {
    return UIColorMakeWithHex(@"#CBC8C8");
}
