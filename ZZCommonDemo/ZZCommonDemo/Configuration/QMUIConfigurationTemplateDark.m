...
- (UIColor *)themeImageViewBackgroundColor {
    return UIColorMakeWithRGBA(100, 100, 100, 1);
}

- (UIColor *)themeTintColor {
    return UIColorMake(39, 192, 243);
}

- (UIColor *)themeTitleTextColor {
    return UIColorMake(218, 220, 224);
}

- (UIColor *)themeMainTextColor {
    return UIColorMake(178, 180, 184);
}

- (UIColor *)themeDescriptionTextColor {
    return UIColorMake(118, 120, 124);
}

- (UIColor *)themePlaceholderColor {
    return UIColorMake(78, 80, 84);
}
