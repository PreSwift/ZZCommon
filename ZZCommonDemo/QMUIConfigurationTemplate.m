...
- (UIColor *)themeTintColor {
    return UIColorMakeWithHex(@"#3F87F4");
}
...
- (UIColor *)themeTitleTextColor {
    return UIColorMakeWithHex(@"#110F0F");
}

- (UIColor *)themeMainTextColor {
    return UIColorMakeWithHex(@"#7B7676");
}

- (UIColor *)themeDescriptionTextColor {
    return UIColorMakeWithHex(@"#A7A0A0");
}

- (UIColor *)themePlaceholderColor {
    return UIColorMakeWithHex(@"#B7B7B7");
}
